...
Поле keep_suggestion во ВХОДНЫХ данных — это выбор системы, рассчитанный по стоимости, а не решение пользователя. В explanation никогда не пиши, что пользователь что-то выбрал, сохранил или предпочёл: он ничего не выбирал. Объясняй только тем, что этот сервис дешевле или закрывает ту же потребность.
